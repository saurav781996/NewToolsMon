...
import com.example.newtoolsmon.unitconvert.Adapters.CategoryAdapter;
import com.example.newtoolsmon.unitconvert.Adapters.ConversionAdapter;
import com.example.newtoolsmon.unitconvert.Adapters.LowerSpinnerAdapter;
import com.example.newtoolsmon.unitconvert.Adapters.SpinnerAdapter;
...
public class ConversionsActivity extends AppCompatActivity {
   ...
   FitButton seeAll;
    ...
    private void initViews() {
        ...
        seeAll = (FitButton) findViewById(R.id.see_all_convs);
                ...
                switch (categorySpinner.getSelectedItemPosition()) {
                    case 0:
                        ...
                        for (int i = 0; i < toSpinner.getChildCount(); i++) {
                            ((TextView) parent.getChildAt(i)).setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.conwhite));
                        }
                        addingWatcher();
                        break;
                    case 1:
